	...
	.main-news__slider.news-slider
		.news-slider__body(ref="sliderNews")
			.news-slider__wrapper.swiper-wrapper
				SectionMainNewsItem(v-for="(item, index) in newsList" :key="index" :item="item" @open-popup-news="openPopupNews(item)")
		.slider-controls
		...
		PopupNews(:is-open="storePopupNews.isOpenPopupNews" :popup-data="popupNewsData" @close-popup="closePopupNews" @button-click="closePopupNews")
</template>
